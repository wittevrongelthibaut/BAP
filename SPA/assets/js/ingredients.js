...
async function initialiseIngredients(){
    clearMain();
    insertIngredientsTemplate();
...
function insertIngredientsTemplate(){
    const ingredientsTemplate = document.querySelector("#ingredientTemplate");
    const ingredientsHtml = ingredientsTemplate.content.cloneNode(true);
    document.querySelector("main").appendChild(ingredientsHtml);
}
